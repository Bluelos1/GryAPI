...
import com.example.gryapi.rest.dto.CreatePublisherDto;
import com.example.gryapi.rest.dto.PublisherDto;
import com.example.gryapi.rest.dto.UpdatePublisherDto;
import com.example.gryapi.rest.service.PublisherService;
...
public class PublisherController {
    ...
    public @ResponseBody ResponseEntity<PublisherDto> getPublisherEntity(@PathVariable Long id) {
        logger.info("Serving GET request for PublisherEntity with id = " + id);
